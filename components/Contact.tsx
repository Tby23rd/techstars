...
const ContactUs: React.FC = () => {
  return (
    <div id="Contacts" className=" mx-auto py-10 px-5 ">
      <h1 className="text-3xl text-blue-900 font-bold text-center mb-5 ">Contact Us</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="w-full shadow rounded-2xl p-4 md:w-1/2">
          <form className="flex flex-col gap-2">
            ...
            <button className="p-2 mt-4 text-white  rounded-2xl transition duration-300 ease-in-out hover:bg-blue-600 font-bold bg-blue-500">Submit</button>
          </form>
        </div>
